...
TEST(RCSplitTest, TestRCDeviceProtocolGeneration)
{
    ...
    r = runcamDeviceSimulateCameraButton(&device, RCDEVICE_PROTOCOL_SIMULATE_POWER_BTN);
    EXPECT_EQ(r, true);
    printf("\n");

    printf("prepare change mode simualtion:\n");
    r = runcamDeviceSimulateCameraButton(&device, RCDEVICE_PROTOCOL_CHANGE_MODE);
    EXPECT_EQ(r, true);
    printf("\n");
    ...
    r = runcamDeviceGetSettings(&device, 0, &settings);
    EXPECT_EQ(r, true);
    if (r) {
    ...
    r = runcamDeviceOpen5KeyOSDCableConnection(&device);
    EXPECT_EQ(r, true);
    printf("\n");

    printf("close 5 key osd cable connection:\n");
    r = runcamDeviceClose5KeyOSDCableConnection(&device);
    EXPECT_EQ(r, true);
    printf("\n");

    printf("5 key osd cable button press set:\n");
    r = runcamDeviceSimulate5KeyOSDCableButtonPress(&device, RCDEVICE_PROTOCOL_5KEY_SIMULATION_SET);
    EXPECT_EQ(r, true);
    printf("\n");

    printf("5 key osd cable button press left:\n");
    r = runcamDeviceSimulate5KeyOSDCableButtonPress(&device, RCDEVICE_PROTOCOL_5KEY_SIMULATION_LEFT);
    EXPECT_EQ(r, true);
    printf("\n");

    printf("5 key osd cable button press right:\n");
    r = runcamDeviceSimulate5KeyOSDCableButtonPress(&device, RCDEVICE_PROTOCOL_5KEY_SIMULATION_RIGHT);
    EXPECT_EQ(r, true);
    printf("\n");

    printf("5 key osd cable button press up:\n");
    r = runcamDeviceSimulate5KeyOSDCableButtonPress(&device, RCDEVICE_PROTOCOL_5KEY_SIMULATION_UP);
    EXPECT_EQ(r, true);
    printf("\n");

    printf("5 key osd cable button press down:\n");
    r = runcamDeviceSimulate5KeyOSDCableButtonPress(&device, RCDEVICE_PROTOCOL_5KEY_SIMULATION_DOWN);
    EXPECT_EQ(r, true);
    printf("\n");
...
extern "C" {
    ...
    void featureClear(uint32_t mask) { UNUSED(mask); }
}
